...
class CartController extends Controller
{
    ...
    public function addToCart(Request $request)
    {
        ...
        if($product->auction_product == 0){
            ...
            $data['gifted'] = $request->add_gift == 1 ? 1 : 0;
            $data['gift_from'] = $request->gift_from;
            $data['gift_recipient'] = $request->gift_recipient;
            $data['gift_message'] = $request->gift_message;

            //echo '<pre>gift';print_r($data);die;
            ...
            if($carts && count($carts) > 0){
                ...
                if (!$foundInCart) {
                    //echo '<pre>gift1';print_r($data);die;
                    Cart::create($data);
                }
            }
            else{
            ...
            if(count($carts) == 0){
                //echo '<pre>gift2';print_r($data);die;
                Cart::create($data);
            }
            if(auth()->user() != null) {
                $user_id = Auth::user()->id;
    ...
    public function removeFromCart(Request $request)
    {
       ...
       /* return array(
        ...
        return response()->json([
            'cart_count' => count($carts),
            'cart_view' => view('frontend.partials.cart_details', compact('carts'))->render(), // Main cart view
            'nav_cart_view' => view('frontend.partials.cart', compact('carts'))->render(),  // Sidebar cart view
        ]);
    }
