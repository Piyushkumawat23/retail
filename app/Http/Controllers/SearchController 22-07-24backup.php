...
class SearchController extends Controller
{
    public function index(Request $request, $category_id = null, $brand_id = null)
    {
        ...
        // Retrieve comma-separated brand IDs from the database
        //$commaSeparatedBrandIds = Product::where('brand_id', $brand_id)->pluck('brand_id')->first();
        //echo '<pre>commaSeparatedBrandIds';print_r($commaSeparatedBrandIds);
        
        // Convert comma-separated string to an array
        //$brandIdsArray = explode(',', $commaSeparatedBrandIds);
        //echo '<pre>brandIdsArray';print_r($brandIdsArray);
        
        // Pass the brand IDs to the view
        //$brand_values = $request->has('brand_values') ? $request->brand_values : $brandIdsArray;
        //echo '<pre>brand_values';print_r($brand_values);die;
        
        
        //echo '<pre>brand_id';print_r($brand_id);die;
        // if ($seller_id != null) {
        ...
        // If brand values are not provided in the request, use the ones from the database
        ...
        //($products->toSql(), $products->getBindings());

        return view('frontend.product_listing', compact('products', 'query', 'category_id', 'brand_id', 'sort_by', 'seller_id', 'min_price', 'max_price', 'attributes', 'selected_attribute_values','selected_shape_values', 'colors', 'selected_color','brand_values'));
    }
