...
class OrderController extends Controller
{
    ...
    {
        $new_user_id = (isset($request->user_id) && !empty($request->user_id)) ? $request->user_id : Auth::user()->id;
        $carts = Cart::where('user_id', $new_user_id)
            ->get();
        ...
        $combined_order->user_id = $new_user_id;
        ...
        foreach ($seller_products as $seller_product) {
            ...
            //echo '<pre>';print_r($request->data[$product->id]);die;
                $shipping += $order_detail->shipping_cost;
                
                $order_detail->gift_from = (isset($cartItem['gift_from']) && !empty($cartItem['gift_from'])) ? $cartItem['gift_from'] : '';
                $order_detail->gift_recipient = (isset($cartItem['gift_recipient']) && !empty($cartItem['gift_recipient'])) ? $cartItem['gift_recipient'] : '';
                $order_detail->gift_message =  (isset($cartItem['gift_message']) && !empty($cartItem['gift_message'])) ? $cartItem['gift_message'] : '';
            ...
            if ($seller_product[0]->coupon_code != null) {
                ...
                $coupon_usage->user_id = $new_user_id;
