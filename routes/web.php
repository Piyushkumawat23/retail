...
Route::post('/api/messages', 'TextMessageController@store');
Route::post('/api/receive-reply', 'TextMessageController@receiveReply');
...
Route::controller(HomeController::class)->group(function () {
    Route::get('/access-denied', 'restrictedCountry')->name('restricted.country');
	...
	Route::get('/cron-resize-images', 'cron_resize_images')->name('cron-resize-images');
...
// Frontend FAQ Route
Route::get('faq', [WebsiteController::class, 'faqFrontend'])->name('faq');
...
Route::group(['middleware' => ['user', 'verified', 'unbanned']], function() {
    ...
    Route::get('/all-notifications', [NotificationController::class, 'index'])->name('all-notifications');
        ...
        //Guest Checkout
    Route::group(['prefix' => 'guestcheckout'], function() {
        Route::controller(GuestCheckoutController::class)->group(function () {
            Route::get('/', 'get_shipping_info')->name('guestcheckout.shipping_info');
            Route::any('/delivery_info', 'store_shipping_info')->name('guestcheckout.store_shipping_infostore');
            Route::post('/payment_select', 'store_delivery_info')->name('guestcheckout.store_delivery_info');
            Route::get('/guest-order-confirmed', 'order_confirmed')->name('guest_order_confirmed');
            Route::post('/payment', 'checkout')->name('payment.guestcheckout');
            Route::post('/get_pick_up_points', 'get_pick_up_points')->name('shipping_info.get_pick_up_points');
            Route::get('/payment-select', 'get_payment_info')->name('guestcheckout.payment_info');
            Route::post('/apply_coupon_code', 'apply_coupon_code')->name('guestcheckout.apply_coupon_code');
            Route::post('/remove_coupon_code', 'remove_coupon_code')->name('guestcheckout.remove_coupon_code');
            //Club point
            Route::post('/apply-club-point', 'apply_club_point')->name('guestcheckout.apply_club_point');
            Route::post('/remove-club-point', 'remove_club_point')->name('guestcheckout.remove_club_point');            
            Route::post('/guest-get-states', 'getStates')->name('guestcheckout.guest-get-state');
            Route::post('/guest-get-cities', 'getCities')->name('guestcheckout.guest-get-city');
            Route::post('/get-tax-rate', 'getTaxRate')->name('guestcheckout.get-tax-rate'); 
            Route::post('/save-guest-total', 'guestTotal')->name('guestcheckout.save-guest-total'); 
...
Route::group(['middleware' => ['customer', 'verified', 'unbanned']], function() {
    ...
    Route::group(['prefix' => 'checkout'], function() {
        Route::controller(CheckoutController::class)->group(function () {
            ...
            Route::post('/get-tax-rate', 'getTaxRate')->name('checkout.getTaxRate'); 
        });
    });
...
Route::controller(PageController::class)->group(function () {
   ...
   // Route::get('/contact-new', 'contact_new')->name('contact-new');
