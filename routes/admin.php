...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::group(['prefix' => 'website'], function() {
        ...
        Route::get('website/faq', [WebsiteController::class, 'faqIndex'])->name('website.faq');
        Route::get('website/faq/create', [WebsiteController::class, 'create'])->name('website.faq.create');
        Route::post('website/faq/store', [WebsiteController::class, 'store'])->name('website.faq.store');
        Route::get('website/faq/edit/{id}', [WebsiteController::class, 'faqEdit'])->name('website.faq.edit');
        Route::post('website/faq/update/{id}', [WebsiteController::class, 'faqUpdate'])->name('website.faq.update');
        Route::get('website/faq/delete/{id}', [WebsiteController::class, 'faqDelete'])->name('website.faq.delete');
    ...
    Route::controller(ReviewController::class)->group(function () {
        ...
        Route::post('/reviews/admin_product_review_modal', 'admin_product_review_modal')->name('admin_product_review_modal');
        Route::post('/reviews/admin_store', 'admin_store')->name('reviews.admin_store');
