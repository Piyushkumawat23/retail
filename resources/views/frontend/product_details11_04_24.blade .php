                            ...
                            <div class="accordion_area">
                                <div class="container">
                                    ...
                                    <div class="col-12"> 
                                        <div id="accordion" class="card__accordion product_detail_accordion">
                                          <?php if(get_setting('show_product_detail') == 'on'){ ?>
                                          <div class="card  card_dipult col-4 float-left">
                                            <div class="card-header card_accor" id="headingTwo">
                                                <button class="btn btn-link collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                                                  Delivery & Return
                                                   <i class="fa fa-plus"></i>
                                ...
                                <div class="custom-col-5 aiz-card-box border border-light rounded hov-shadow-md mt-1 mb-2 has-transition bg-white margin_left">
                                    <div class="single_product">
                                        <div class="product_thumb">
                                            <a class="primary_img" href="{{ route('product', $top_product->slug) }}"><img src="{{ uploaded_asset($top_product->thumbnail_img) }}" class="img-fit lazyload mx-auto h-200px h-md-310px" alt=""></a>
                                            <a class="secondary_img" href="{{ route('product', $top_product->slug) }}"><img src="{{ uploaded_asset($top_product->thumbnail_img) }}" class="img-fit lazyload mx-auto h-200px h-md-310px" alt=""></a><!-- 
