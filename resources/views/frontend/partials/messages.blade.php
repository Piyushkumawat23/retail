                ...
                <div class="pl-3">
                    <div class="block-image">
                        @if ($message->user->avatar_original != null)
                            <img loading="lazy" src="{{ uploaded_asset($message->user->avatar_original) }}" class="rounded-circle">
                        @else
                            <img loading="lazy" src="{{ static_asset('assets/img/avatar-place.png') }}" class="rounded-circle">
                        @endif
                    </div>
                </div>
