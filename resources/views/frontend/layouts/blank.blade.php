...
@if (get_setting('facebook_pixel') == 1)
    ...
    <noscript>
        <img loading="lazy" height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id={{ env('FACEBOOK_PIXEL_ID') }}&ev=PageView&noscript=1"/>
    </noscript>
...
<body>
    ...
    <div class="aiz-main-wrapper d-flex flex-column">
        ...
        <!-- Header -->
         ...
         <div class="new-header" style="<?php echo (Route::currentRouteName() == 'product') ? 'margin-bottom: 0%'  : 'margin-bottom: 5%'?>"></div>
       @endif
...
// Check if the child checkbox is checked
		...
		/*$( document ).ready(function() {
			setTimeout(
			  ...
			  { 
					...
					var iframe = document.getElementById("iframe_lazy_load");
					var iframe_url = $('#iframe_lazy_load').attr('video_path');
					iframe.src = iframe_url;
					
					$('.slider_video_img').hide();
					$('.slider_video_iframe').show();
			  }, " 3000");
		});*/
	   
		/*$( document ).ready(function() {
			 setTimeout(function() {
				$('.home_slider_video').html('<div class="slider_area single_slider owl-carousel" data-autoplay="true" style="display:block"><video id="background-video" class="carousel-box" autoplay="true" loop muted style="width:100%" ><source  src="<?php echo static_asset('assets/banner-video/5.mp4'); ?>"></video></div>');
				
				var video = document.getElementById('background-video');
				video.play(); // Start playing the video
				video.addEventListener('ended', function() {
				  // When the video ends, restart it (loop)
				  this.currentTime = 0;
				  this.play();
				}); 
