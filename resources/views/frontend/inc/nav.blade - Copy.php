                    ...
                    <div class="Offcanvas_menu_wrapper">
                        ...
                        <div class="welcome_text">
                             <a href="{{ route('home') }}">
                                ...
                                @endphp
                                @if($header_logo != null)
                                    <img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}" class="mw-100 h-30px h-md-auto logo-mid" height="40">
                                @else
                                    <img src="{{ static_asset('assets/img/logo.png') }}" alt="{{ env('APP_NAME') }}" class="mw-100 h-30px h-md-auto" height="40">
                                @endif 
                            </a>    
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="{{ route('products.category', $menu_category->slug) }}">
                                                           <!--  <img src="{{ uploaded_asset($menu_category->icon) }}" alt="{{ $menu_category->getTranslation('name') }} icon" style="width: 40px; height: 45px; margin-right: 8px;"> -->
                                                            ...
                                                            <li>
                                                                <a href="{{ route('products.category', $menu_category->slug) }}">
                                                                   <!--  <?php //   if(!empty($menu_category->icon)){ ?>
                                                                        <img src="{{ uploaded_asset($menu_category->icon) }}" alt="{{ $menu_category->getTranslation('name') }} icon" class="menu-icon"> 
                                                                    <?php //} else { ?>
