@extends('frontend.layouts.app')
  @section('meta')
    <link rel="canonical" href="https://bautlr.com/users/registration">
    @stop
@section('content')
    <!-- customer resgister start -->
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="account_form register">
                        <h2>{{ translate('Create an account.')}}</h2>
