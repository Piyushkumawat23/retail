...
<style>
    ...
    .overlay_new {
        ...
        width: 100%;
        height: 100%;
        background: rgba(0, 0, 0, 0.3); /* Default overlay for larger screens */
    }
    ...
    @media (max-width: 768px) {
        ...
        .overlay_new {
            top: -3px; /* Adjust the top position for mobile */
            opacity: 0.2; /* Reduce opacity for mobile */
        }
    }
    ...
    @media (max-width: 480px) {
        ...
        .overlay_new {
            opacity: 0.1; /* Further reduce overlay opacity for very small devices */
        }
    }
</style>
...
@if(get_setting('topbar_banner_video') != null)
    <?php $banner_video = uploaded_asset(get_setting('topbar_banner_video')); ?>
        <div class="home_slider_video" data-autoplay="true">
            <video id="background-video" autoplay loop muted preload="none" style="width:100%">
                            ...
                            <div class="new_banner-content">
                                ...
                                <div class="new_features">
                                    <div class="new_feature">
                                        <img loading="lazy" src="{{ static_asset('assets/img/banner/Hallmarked.webp') }}" alt="Hallmark Icon">
                                        <p>Hallmarked Jewellery</p>
                                    </div>
                                    <div class="new_feature">
                                        <img loading="lazy" src="{{ static_asset('assets/img/banner/verified.webp') }}" alt="Certified Icon">
                                        <p>Certified Jewellery</p>
                                    </div>
                                    <div class="new_feature">
                                        <img loading="lazy" src="{{ static_asset('assets/img/banner/trust.webp') }}" alt="Best online jewelry store in USA">
...
<script type="text/javascript">
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if ('IntersectionObserver' in window) {
            let observer = new IntersectionObserver(function(entries, observer) {
                entries.forEach(entry => {
                    if (entry.isIntersecting) {
                        video.load();  // Load the video when it comes into view
            ...
            // Fallback: Load the video immediately if IntersectionObserver is not supported
            video.load();
        }
    });
</script>  
