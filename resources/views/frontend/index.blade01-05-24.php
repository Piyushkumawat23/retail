                   ...
                   <div class="single_banner">
                       <div class="banner_thumb banner_size">
                            <a href="{{ json_decode(get_setting('home_banner1_links'), true)[$key] }}">
                                <img src="{{ uploaded_asset($banner_1_imags[$key]) }}" data-src="{{ uploaded_asset($banner_1_imags[$key]) }}" alt="{{ env('APP_NAME') }} promo" class="img-fluid lazyload w-100 img-fit mx-auto h-md-500px">
                            </a>
