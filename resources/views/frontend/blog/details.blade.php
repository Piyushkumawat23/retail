...
@section('meta_title'){{ get_setting('website_name').' | '. $blog->meta_title }}@stop
...
@section('content')
    ...
    <div class="breadcrumbs_area blog_breadcrumbs" >
        <div class="container">   
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumb_content">
                    <h2>{{ Str::words($blog->title, 6) }}</h2>
                        <ul>
                            <li><a href="{{ route('home') }}">{{ translate('Home')}}</a></li>
                            <li>></li>
                            <li><a href="{{ route('blog') }}">{{ translate('Blogs') }}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xl-9 mx-auto">
                <div class="bg-white rounded shadow-sm p-4"> 
                    ...
                    <div class="mb-4 overflow-hidden blog-detail-page">
                        {!! $blog->description !!}
                    </div>
