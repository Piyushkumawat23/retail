...
@section('meta_title'){{ get_setting('website_name').' | '.$detailedProduct->meta_title }}@stop
...
<script type="application/ld+json">
    {
      ...
      "brand": {
        "@type": "Brand",
        "name": "{{ $detailedProduct->brand->name ?? 'Bautlr' }}"
      },
      "offers": {
        "@type": "Offer",
...
{{-- "availability": "https://schema.org/{!! ($detailedProduct->stock_visibility_state == 'qty' && $qty > 0) ? 'InStock' : 'OutOfStock' !!}" --}}
@endsection
...
@section('content')
                ...
                <div class="col-lg-6 col-md-6 product_img_all_new" id="product_img_all">
                   <div class="product-details-tab">
                        @php
                            ...
                            $product_image = get_product_image($detailedProduct->thumbnail_img);
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product_d_right">                           
                            ...
                            <!-- <div class=" product_ratting">
                                <ul>
                                     @php
                                        ...
                                        $total += $detailedProduct->reviews->count();
                                    @endphp
                                    <?php //echo '<pre>';print_r($detailedProduct->rating);die;?>
                                    <li><a href="#">{{ renderStarRating($detailedProduct->rating) }}</i></a></li>
                        ...
                        <form id="option-choice-form">
                                ...
                                <div class="row no-gutters mt-4 gemstone-list-product">
                                        ...
                                        foreach ($subProduct as $key => $value){ 
                                            ...
                                            <div class="col-sm-3 col-4 float-left" style="padding-left: 0px;    padding-right: 5px;">
                                                ...
                                                <a 
                                                    href="{{ ($detailedProduct->slug==$value->slug)?'javascript:void(0)':route('product', $value->slug) }}" 
                                                    class="d-block <?php echo ($detailedProduct->slug==$value->slug)? 'selected-metal' : '' ;?> text-reset {{$active}} change-image rt{{ $value->slug }} rt{{ $value->slug }}" 
                                ...
                                <div class="row clearfix mini_product">
                                ...
                                @if ($detailedProduct->choice_options != null)
                                    ...
                                    <div class="row no-gutters product_variant qty_box">
                                        <div class="col-sm-2">
                                            <div class="my-2">{{ $attribute_name }}:</div>
                                        </div>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="product-quantity d-flex align-items-center">
                                            ...
                                            <div class="avialable-amount opacity-60" >
                                                ...
                                                (*<span id="in-stock-quantity">{{ get_setting('in_stock_text') }}</span>)
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                ...
                                {{-- <div class="row no-gutters pb-3" id="chosen_price_div">
                                    ...
                                    <div class="col-sm-6 float-left">
                                        ...
                                        <div class="col-sm-7 float-right product_variant">
                                    ...
                                    <div class="col-sm-6 float-right ">
                                        <div class="product_instruction">
                                            <h5>About Product:</h5>
                                            <?php echo get_setting('product_instruction') ?>
                                        </div>
                                    </div>
                                </div>   --}}
                                ...
                                <div class="row no-gutters pb-3" id="chosen_price_div">
                                    <div class="col-sm-12">
                                        <div class="d-flex align-items-center">
                                            <div class="product_variant me-2">
                                        ...
                                        <div class="product_detail_page mt-2">
                                            (*Shipping free above $75)
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- <div class="row align-items-center">
                                        <div class="col-auto    ">
                                            <button class="btn btn-sm btn-soft-primary" onclick="show_chat_modal()">{{ translate('Message')}}</button>
                                        </div>                             
                                </div> -->
                                <div class="col-6">
                                    <label class="aiz-checkbox">
                                        <input type="checkbox" id="add_gift_checkbox">
                                        <span>Add Gift Options</span>
                                        <span class="aiz-square-check"></span>
                                    </label>
                                    <input type="hidden" name="add_gift" id="add_gift_hidden">
                                </div>
                                <div id="gift_options" style="display: none;" class=" col-12">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="gift_from">From</label>
                                                <input type="text" class="form-control gift" id="gift_from" name="gift_from">
                                            </div>
                                        </div>
                                        <div class="col-6"  >
                                            <div class="form-group">
                                                <label for="gift_recipient">Recipient Name</label>
                                                <input type="text" class="form-control gift" id="gift_recipient" name="gift_recipient">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="gift_message" name="gift_message" rows="3" col="2"></textarea>
                                    </div>
                                </div>
                        </form>
                                        ...
                                        <div id="accordion" class="card__accordion product_detail_accordion">
                                          ...
                                          <div class="card  card_dipult">
                                            <div class="card-header card_accor" id="headingTwo">
                                                <button class="btn btn-link collapsed card_heading" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                                                  Delivery & Return
                                                   <i class="fa fa-plus"></i>
                                                   <i class="fa fa-minus"></i>
                                            ...
                                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                                              <div class="card-body">
                                                <?php  echo get_setting('product_delivery_return'); ?>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="card  card_dipult">
                                            <div class="card-header card_accor" id="headingThree">
                                                <button class="btn btn-link collapsed card_heading" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                 Warranty
                                                   <i class="fa fa-plus"></i>
                                                   <i class="fa fa-minus"></i>
                                                </button>
                                            ...
                                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                                              <div class="card-body">
                                                <?php  echo get_setting('product_warranty'); ?>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="card  card_dipult">
                                            <div class="card-header card_accor" id="headingfour">
                                                <button class="btn btn-link collapsed card_heading" data-bs-toggle="collapse" data-bs-target="#collapseeight" aria-expanded="false" aria-controls="collapseeight">
                                                 Metal
                                                   <i class="fa fa-plus"></i>
                                                   <i class="fa fa-minus"></i>
                                                </button>
                                            ...
                                            <div id="collapseeight" class="collapse" aria-labelledby="headingfour" data-parent="#accordion">
                                              <div class="card-body">
                                                <?php  echo get_setting('product_metal'); ?>
                                              </div>
                                            </div>
                                          </div>
                                          <?php } ?>
                                ...
                                <div class="reviews_wrapper">
                                    ...
                                    <div class="reviews_comment_box">
                                        <!-- <div class="comment_thmb">
                                            ...
                                            @if(isset($review->user->avatar_original) && $review->user->avatar_original !=null)
                                            ...
                                            <div class="reviews_meta">
                                                ...
                                                <!-- <div class="star_rating">
                                                    <ul>
                                                        <li>
                                                            @for ($i=0; $i < $review->rating; $i++)
                                                            <a href='javascript:void(0)'><i class="fa fa-star active"></i></a>
                                                            @endfor
                                                            @for ($i=0; $i < 5-$review->rating; $i++)
    ...
    <div class="product_d_info">
        <div class="container">   
            <div class="row">
                <div class="col-12">
                    <div class="tab-content" style="min-height:100px !important;">  
                    <div class="product_instruction">
                        <h5>About Product:</h5>
                        <?php echo get_setting('product_instruction') ?>
                    </div>  
    ...
    <!--product section area end-->
        ...
        <div class="modal fade" id="chat_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
           ...
           <!-- TRY ON Modal -->
        <div class="modal fade" id="tryOnModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom product-modal" role="document">
            <div class="modal-content position-relative">
                <div class="modal-header">
                    <h5 class="modal-title fw-600 h5">Try On</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true"></span>
                    </button>
                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div id="humanModel">
                                    ...
                                    <div id="sliderContainer">
                                        <input type="range" id="skinToneSlider" min="30" max="100" value="50">
                                    </div>
                                </div>
...
/*    <?php if(isset($_GET['metal']) && !empty($_GET['metal'])){
    ...
    <?php } ?>*/
        ...
        document.getElementById('add_gift_checkbox').addEventListener('change', function() {
            if (this.checked) {
                document.getElementById('add_gift_hidden').value = 1;
            } else {
                document.getElementById('add_gift_hidden').value = 0;
            }
        });

        $(document).ready(function() {
            $('#add_gift_checkbox').change(function() {
                if ($(this).is(':checked')) {
                    $('#gift_options').show();
                } else {
                    $('#gift_options').hide();
