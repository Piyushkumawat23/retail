               ...
               <!-- <div class="col-lg-3 position-static d-none d-lg-block">
                ...
                <div class="@if($num_todays_deal > 0) col-lg-12 @else col-lg-12 @endif">
                        <div class="aiz-carousel dots-inside-bottom mobile-img-auto-height" data-arrows="true" data-dots="true" data-autoplay="true">
                            ...
                            <video id=" background-video"class="carousel-box" autoplay loop muted>
                                <source  src="{{static_asset('assets/banner-video/5.mp4')}}">
                            </video>
                        </div>
                        <div class="video-content">
                            <h1>Boho Garnet Ring</h1>
                            <p>We provide the exquisite craftsmanship of beautiful jewellery designs such as rings, earrings, pendants, necklace, chains, bangles, bracelets, ...</p>
                            <!-- Use a button to pause/play the video with JavaScript -->
                            <button id="myBtn" >Shop Now</button>
                        </div>
