    	...
    	<div class="col-lg-8 mx-auto">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <h6 class="fw-600 mb-0">{{ translate('Product Stock Text & Instruction') }}</h6>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-md-3 col-from-label">{{ translate('In Stock') }}</label>

                            <div class="col-md-8">

                                <input type="hidden" name="types[]" value="in_stock_text">

                                <input type="text" class="form-control" name="in_stock_text" value="{{ get_setting('in_stock_text') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="hidden" name="types[]" value="out_stock_text">

                                <textarea class="resize-off form-control" name="out_stock_text">{{  get_setting('out_stock_text') }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-md-3 col-from-label">{{ translate('Product Instruction') }}</label>

                            <div class="col-md-8">

                                <input type="hidden" name="types[]" value="product_instruction">

                                <textarea name="product_instruction" rows="4" class="aiz-text-editor form-control" data-buttons='[["font", ["bold"]],["insert", ["link"]]]'>{{ get_setting('product_instruction') }}</textarea>
    		...
    		<div class="card">
    			...
    			<div class="card-header">
    				...
    				<h6 class="fw-600 mb-0">{{ translate('Product Detail') }}</h6>
    			...
    			<div class="card-body">
    				...
    				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
    					...
    					<div class="form-group row">
    						...
    						<label class="col-md-3 col-from-label">{{ translate('Delivery & Return') }}</label>

                            <div class="col-md-8">

        						<input type="hidden" name="types[]" value="product_delivery_return">

        						<textarea name="product_delivery_return" rows="4" class="aiz-text-editor form-control" data-buttons='[["font", ["bold"]],["insert", ["link"]]]'>{{ get_setting('product_delivery_return') }}</textarea>
    					...
    					<div class="form-group row">
                            ...
                            <div class="col-md-8">
        						...
        						<input type="hidden" name="types[]" value="product_warranty">

        						<textarea name="product_warranty" rows="4" class="aiz-text-editor form-control" data-buttons='[["font", ["bold"]],["insert", ["link"]]]'>{{ get_setting('product_warranty') }}</textarea>
    					...
    					<div class="form-group row">
    						...
    						<label class="col-md-3 col-from-label">{{ translate('Product Metal') }}</label>

                            <div class="col-md-8">

        						<input type="hidden" name="types[]" value="product_metal">

        						<textarea name="product_metal" rows="4" class="aiz-text-editor form-control" data-buttons='[["font", ["bold"]],["insert", ["link"]]]'>{{ get_setting('product_metal') }}</textarea>
                        ...
                        <div class="form-group row">
    						...
    						<label class="col-md-3 col-from-label">{{translate('Show Product Default Detail?')}}</label>

    						<div class="col-md-8">

    							<label class="aiz-switch aiz-switch-success mb-0">

    								<input type="hidden" name="types[]" value="show_product_detail">

    								<input type="checkbox" name="show_product_detail" @if( get_setting('show_product_detail') == 'on') checked @endif>
