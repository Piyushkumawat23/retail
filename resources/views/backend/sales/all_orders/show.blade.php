                ...
                <table class="table table-bordered aiz-table invoice-summary">
                    <thead>
                        <tr class="bg-trans-dark">
                            ...
                            <th data-breakpoints="lg" class="text-uppercase">Gift From</th>
                            <th data-breakpoints="lg" class="text-uppercase">Gift Receipent</th>
                            <th data-breakpoints="lg" class="text-uppercase">Gift Message</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ $orderDetail->gift_from }}</td>
                            <td class="text-center">{{ $orderDetail->gift_recipient }}</td>
                            <td class="text-center">{{ $orderDetail->gift_message }}</td>
