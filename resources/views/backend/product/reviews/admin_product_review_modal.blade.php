<div class="modal-header">
    ...
    <form action="{{ route('reviews.admin_store') }}" method="POST" >
        @csrf
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <label class="opacity-60">{{ translate('User Name')}}</label>
                <input type="text" class="form-control" name="user_name" placeholder="{{ translate('User Name')}}" required>
            </div>
            <div class="form-group">
