    ...
    <div class="card">
        <div class="card-body p-0">
            ...
            <form class="p-4" action="{{ route('brands.update', $brand->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                name="seo_content">{{ $brand->seo_content }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-from-label">{{translate('H1 Tag')}}</label>
                    <div class="col-lg-8">
                        <input type="text" class="form-control" name="h1_tag" value="{{ $brand->h1_tag }}" placeholder="{{translate('H1 Tag')}}">
                    </div>
                </div>
                <div class="form-group row">
