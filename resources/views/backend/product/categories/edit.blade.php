        ...
        <div class="card">
            <div class="card-body p-0">
                ...
                <form class="p-4" action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">{{translate('H1 Tag')}}</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="h1_tag" value="{{ $category->h1_tag }}" placeholder="{{translate('H1 Tag')}}">
                        </div>
                    </div>
                    <div class="form-group row">
