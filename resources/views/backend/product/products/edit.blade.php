                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" id="brand">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control aiz-selectpicker" name="brand_id[]" id="brand_id" data-live-search="true" multiple>
                                    <option value="">{{ translate('Select Gemstone') }}</option>
                                    @foreach (\App\Models\Brand::all() as $brand)
                                        @php
                                            $selectedBrands = explode(',', $product->brand_id);
                                        @endphp
                                       
                                           // echo '<pre>';print_r($selectedBrands);die;
                                        
                                        <option value="{{ $brand->id }}" @if(in_array($brand->id, $selectedBrands)) selected @endif>{{ $brand->getTranslation('name') }} {{ !empty($brand->gemstone_month) ? ' - '. $brand->gemstone_month : '' }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                       ...
                       <!--  <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="signinSrEmail">{{translate('Hover Image')}}</label>
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    ...
                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                    <input type="hidden" name="hover_img" value="{{ $product->hover_img }}" class="selected-files">
                                </div>
                                <div class="file-preview box sm">
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="signinSrEmail">{{translate('Hover Video')}} <small>(MAX 2MB)</small></label>
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="aizuploader" data-type="video" data-multiple="false">
                                    ...
                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                    <input type="hidden" type="file" id="hover_video" name="hover_video" value="{{$product->hover_video}}" class="selected-files">
                                </div>
                                <div class="file-preview box sm">

                                </div>
                                <small class="text-muted">{{translate('These Videos are visible on product box. Use Videos Max Size 2MB.')}}</small>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-from-label">{{translate('Alt Image Tag')}}</label>
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="img_alt_text" placeholder="{{translate('Alt Image Tag')}}" value="{{ $product->img_alt_text }}">
                            </div>
                        </div>
                        {{-- <div class="form-group row">
                        <label class="col-lg-3 col-from-label">{{translate('Hover Image')}}</label>
                        <div class="col-lg-8">
                            <div id="photos">
                                @if(is_array(json_decode($product->hover_img)))
                                @foreach (json_decode($product->hover_img) as $key => $photo)
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label class="col-md-6 col-from-label">{{translate('Made To Order')}}</label>
                                    <div class="col-md-6">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                            <input type="checkbox" class="made_to_order" name="made_to_order" value="1" @if($product->made_to_order == 1) checked @endif >
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
