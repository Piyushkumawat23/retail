...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        ...
        <div class="text-right">
            <a href="{{route('product_bulk_export.index')}}" class="btn btn-circle btn-info">
    ...
    <form class="" id="sort_products" action="" method="GET">
        ...
        <div class="card-body">
            <table class="table aiz-table mb-0">
                ...
                <tbody>
                    <?php //echo '<pre>productstest';print_r($products);die; ?>
                    ...
                    <tr>
                        ...
                        @if($type == 'Seller' || $type == 'All')
                        <?php /*echo '<pre>';print_r($product->user['name']);die;*/?>
                            <td><?php echo isset( $product->user['name'] ) ?$product->user['name']: '-' ?></td>
                        @endif
                        <td>
                        ...
                        <td class="text-right">
                           ...
                           <!--  <a class="btn btn-soft-warning btn-icon btn-circle btn-sm" href="{{route('products.duplicate', ['id'=>$product->id, 'type'=>$type]  )}}" title="{{ translate('Duplicate') }}">
                            ...
                            <a href="javascript:void(0);"
                                onclick="product_review('{{ $product->id }}')"
                                class="btn btn-primary btn-sm"> {{ translate('Add Review') }}
                            </a>
                        </td>
                    </tr>
                    @endforeach
...
<div id="info-modal" class="modal fade">
    ...
    <div class="modal fade" id="admin-product-review-modal">
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom product-modal">
            <div class="modal-content" id="admin-product-review-modal-content">
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function product_review(product_id) {
            //alert(product_id);
            $.post('{{ route('admin_product_review_modal') }}', {
                _token: '{{ @csrf_token() }}',
                product_id: product_id
            }, function(data) {
                $('#admin-product-review-modal-content').html(data);
                $('#admin-product-review-modal').modal('show');
