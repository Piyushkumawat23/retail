            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    ...
                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                    <input type="hidden" name="hover_img"  class="selected-files">
                                </div>
                                <div class="file-preview box sm">
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="aizuploader" data-type="video" data-multiple="true">
                                    ...
                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                    <input type="hidden" type="file" id="hover_video" name="hover_video" class="selected-files">
                                </div>
                                <div class="file-preview box sm">
                                </div>
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Alt Image Tag')}}</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="img_alt_text" placeholder="{{ translate('Alt Image Tag') }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                            <input type="checkbox" class="made_to_order" name="made_to_order" value="1">
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
