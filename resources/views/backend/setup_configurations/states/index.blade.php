                    ...
                    <table class="table aiz-table mb-0">
                        <thead>
                            <tr>
                                ...
                                <th>{{translate('Standard Shipping Cost')}}</th>
                                <th>{{translate('Priority Shipping Cost')}}</th>
                        ...
                        <tbody>
                            @foreach($states as $key => $state)
                                <tr>
                                    ...
                                    <td>{{ single_price($state->normal_shipping_cost) }}</td>
                                    <td>{{ single_price($state->shipping_cost) }}</td>
                                    <td>
